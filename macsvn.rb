...
class Macsvn < Formula
  ...
  def install
    ...
    system "install_name_tool", "-change", "/usr/local/opt/openssl@3/lib/libssl.3.dylib", "#{lib_path}/openssl/lib/libssl.3.dylib", "#{lib_path}/serf/lib/libserf-1.1.3.0.dylib"
  end
end
